...
namespace Kooboo.CMS.Content.Persistence.SqlServer.QueryProcessor
{
    ...
    public class SQLServerVisitor<T> : ExpressionVisitor
        where T : ContentBase
    {
        ...
        public SQLServerVisitor(List<Parameter> parameters)
        {
        ...
        //public override void ReverseOrder()
        //{
        //    base.ReverseOrder();
        //    OrderClauses.Reverse();
        //}
        ...
        private SQLServerVisitor<T> VisitInner(IExpression expression)
        {
            SQLServerVisitor<T> visitor = new SQLServerVisitor<T>(this.Parameters);
