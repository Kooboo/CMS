...
namespace Kooboo.CMS.Content.Tests.Persistence
{
    ...
    public class QueryTests
    {
        ...
        public QueryTests()
        {
            ...
            newsSchema.AddColumn(new Column() { Name = "title", DataType = DataType.String });
        ...
        [TestMethod]
        public void Test_WhereBetweenOrEqual()
        {
            var news = newsFolder.CreateQuery().WhereBetweenOrEqual("comments", 0, 1).Count();
