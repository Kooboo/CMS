    ...
    public class MediaContent : ContentBase
    {
        ...
        public string FileName
        {
            ...
            set
            {
                ...
                this.FileType = extension.Substring(extension.LastIndexOf(".") + 1);
            }
        ...
        public double Size
        {
            get
            {
                if (this.ContainsKey("Size") && base["Size"] != null)
                {
                    return (double)base["Size"];
                }
                return 0;
            }
            set
        ...
        public string FileType
        {
            get
            {
                if (this.ContainsKey("FileType") && base["FileType"] != null)
                {
