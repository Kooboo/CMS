...
namespace Kooboo.CMS.ExtensionTemplate.Areas.EmptyModule
{
    ...
    {
        public const string ModuleName = "EmptyModule";
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            context.MapRoute(
               ModuleName + "_default",
                ...
                , null
                , new[] { "Kooboo.CMS.ExtensionTemplate.Areas.EmptyModule.Controllers", "Kooboo.Web.Mvc", "Kooboo.Web.Mvc.WebResourceLoader" }
            );
