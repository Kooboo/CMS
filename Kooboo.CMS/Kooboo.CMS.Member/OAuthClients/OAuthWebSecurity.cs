...
namespace Kooboo.CMS.Member.OAuthClients
{
    public static class OAuthWebSecurity
    {
        ...
        public static AuthResult VerifyAuthentication(Membership membership, HttpContextBase httpContext, string returnUrl)
        {
            return VerifyAuthenticationCore(membership, httpContext, returnUrl);
        }

        internal static AuthResult VerifyAuthenticationCore(Membership membership, HttpContextBase context, string returnUrl)
        {
            IAuthClient client;
