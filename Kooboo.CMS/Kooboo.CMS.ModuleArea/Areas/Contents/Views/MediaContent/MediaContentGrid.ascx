    ...
    <table class="left">
        <tbody>
            <tr>
                ...
                <td>
                    <a href="<%=Url.Action("LargeFile",routes) %>" class="o-icon muti-upload" title="<%:"Flash uploader".Localize() %>">
                        Large File</a>
                </td>
                <td>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr class="filetr">
                ...
                <td>
                    <input name="previewUrl" value="<%=content.Url %>" type="hidden" />
                    <input type="hidden" value="<%=Url.Action("RenameFile","MediaContent",currentRoutes) %>"
                        name="editUrl" />
                    <a href="<%=content.Url %>" class="f-icon file f-<%=content.FileType.ToLower() %>"
                ...
                <td class="actionm ">
                    <a href="<%=Url.Action("MoveFile",ViewContext.RequestContext.AllRouteValues().Merge("uuid",content.UUID))%>"
                        class="o-icon move-page dialog-link" title="move"></a>
                </td>
            </tr>
            <% } %>
            <%} %>
