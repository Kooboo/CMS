...
(function (ctx, $) {
    ...
    editor.prototype = {
        ...
        heading: function (tagName) {
		if(tagName === undefined) {
			return this.queryCommandValue('FormatBlock');
		}
		else{
			if(this.Selection.hasSelection()) {
				tagName = ctx.isIE?'<'+tagName+'>':tagName;
				var flag = document.execCommand('FormatBlock', false, tagName)
				if(flag){
