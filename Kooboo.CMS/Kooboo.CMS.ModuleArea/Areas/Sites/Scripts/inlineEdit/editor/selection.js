...
(function () {
    ...
    var selectionClass = function (win) {
        this._window = win;
        this.isIE = yardi.isIE;
        this.isOpera = yardi.isOpera;
        this.isSafari = yardi.isSafari;
        this.isSafari2 = yardi.isSafari2;
    };
    ...
    selectionClass.utils = {
        ...
        setElementInnerHtml: function (el, html) {
            var newHtml = yardi.isIE ? this.getStoredOriginalPathsAndAttributes(html) : html;
    ...
    // register
    yardi.selectionClass = selectionClass;
