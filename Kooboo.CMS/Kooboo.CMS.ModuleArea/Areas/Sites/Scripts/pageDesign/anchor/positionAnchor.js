...
(function ($) {
    ...
    */
    ...
    yardi.extend(positionAnchor, yardi.anchorBar, {
        ...
        initialize: function () {
            ...
            this.components.btnAddView = new yardi.imageButton({
                ...
                renderTo: this.el,
                imageUrl: 'anchor/images/add_view.png',
            ...
            this.components.btnAddModule = new yardi.imageButton({
                ...
                renderTo: this.el,
                imageUrl: 'anchor/images/add_module.gif',
            ...
            this.components.btnAddFolder = new yardi.imageButton({
                ...
                renderTo: this.el,
                imageUrl: 'anchor/images/add_folder.gif',
            ...
            this.components.btnAddHtml = new yardi.imageButton({
                ...
                renderTo: this.el,
                imageUrl: 'anchor/images/add_html.png',
            ...
            this.components.btnAddHtmlBlock = new yardi.imageButton({
                ...
                renderTo: this.el,
                imageUrl: 'anchor/images/add_htmlBlock.png',
