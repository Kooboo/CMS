...
{
    [Kooboo.CMS.Common.Runtime.Dependency.Dependency(typeof(IPath<OutgoingQueue>))]
    public class OutgoingQueuePath:IPath<OutgoingQueue>
    {
        const string PATH_NAME = "OutgoingQueues";
