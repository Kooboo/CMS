...
{
    [Kooboo.CMS.Common.Runtime.Dependency.Dependency(typeof(IPath<PublishingQueue>))]
    public class PublishingQueuePath:IPath<PublishingQueue>
    {
        const string PATH_NAME = "PublishingQueues";
        public PublishingQueuePath(IBaseDir baseDir)
        {
        ...
        public PublishingQueuePath(PublishingQueue entity,IBaseDir baseDir)
        {
            this.PhysicalPath = Path.Combine(baseDir.Cms_DataPhysicalPath, PathHelper.PublishingFolderName, PATH_NAME);
            this.VirtualPath = UrlUtility.Combine(baseDir.Cms_DataVirtualPath, PathHelper.PublishingFolderName, PATH_NAME);
