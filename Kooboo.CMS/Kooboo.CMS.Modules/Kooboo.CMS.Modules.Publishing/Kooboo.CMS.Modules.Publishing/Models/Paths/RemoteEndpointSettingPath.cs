...
{
    [Kooboo.CMS.Common.Runtime.Dependency.Dependency(typeof(IPath<RemoteEndpointSetting>))]
    public class RemoteEndpointSettingPath:IPath<RemoteEndpointSetting>
    {
        const string PATH_NAME = "RemoteEndpointSettings";
        public RemoteEndpointSettingPath(IBaseDir baseDir)
        {
        ...
        public RemoteEndpointSettingPath(RemoteEndpointSetting entity,IBaseDir baseDir)
        {
            this.PhysicalPath = Path.Combine(baseDir.Cms_DataPhysicalPath, PathHelper.PublishingFolderName, PATH_NAME);
            this.VirtualPath = UrlUtility.Combine(baseDir.Cms_DataVirtualPath, PathHelper.PublishingFolderName, PATH_NAME);
