...
namespace Kooboo.CMS.Modules.Publishing.Models
{
    #region Persistence
    [DataContract]
    public partial class RemotePublishingQueue : IIdentifiable, IPublishingQueueItem
    {
        [DataMember]
    ...
    public partial class RemotePublishingQueue : IPersistable, ISiteObject
    {
        ...
        public RemotePublishingQueue(Site site, string uuid)
        {
            this.Site = site;
            this.UUID = uuid;
        }
