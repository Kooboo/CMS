...
namespace Kooboo.CMS.Search
{
    public class DocumentConverter
    {
        ...
        {
            Document doc = null;
            var converter = Converters.GetConverter(o.GetType());
        ...
        public virtual ResultObject ToResultObject(Highlighter highlighter, Document doc)
        {
            ...
            var converter = Converters.GetConverter(nativeType);
            ...
            Thread thread = new Thread(() =>
{
    try
    {
        if (o is TextContent)
        {
            ...
            Persistence.Providers.LastActionProvider.Add(lastAction);
        }
    }
    catch (Exception e)
    {
