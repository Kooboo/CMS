...
namespace Kooboo.CMS.Sites.ABTest
{
    ...
    /// 
    /// </summary>
    [Kooboo.Common.ObjectContainer.Dependency.Dependency(typeof(IVisitRule), Kooboo.Common.ObjectContainer.Dependency.ComponentLifeStyle.Transient, Key = "UserAgentVisitRule")]
