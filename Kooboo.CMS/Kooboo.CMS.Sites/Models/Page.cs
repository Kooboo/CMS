...
namespace Kooboo.CMS.Sites.Models
{
    ...
    public class PageRoute
    {
        ...
        /// 4. 以#开头，此时可以满足一些特殊的URL需求，比如： news/{userKey}/thankyou， 此时thankyou页面应该是在news的第二级，中间还会存在一级页面，比如：details，用{userkey}代替了Details。
        /// 
    ...
    #region Persistence
    [DataContract]
    public partial class Page : IPersistable
    {
