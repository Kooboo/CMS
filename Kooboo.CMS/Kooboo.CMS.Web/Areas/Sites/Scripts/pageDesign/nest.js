...
(function ($) {
    ...
    var settings = {
        ...
        iframeMarkup: '<iframe id="pageDesign" width="100%" height="500" frameborder="0" scrolling="no" src="javascript:false;"></iframe>',
        // redo undo
        btnUndo: '#btnUndo',
        btnRedo: '#btnRedo',
        // hidden inputs
    ...
    function bindRedoundo(redoundo) {
        var btnUndo = $(settings.btnUndo).unbind('click').click(function () { redoundo.undo(); });
        var btnRedo = $(settings.btnRedo).unbind('click').click(function () { redoundo.redo(); });
