...
<tr>
    ...
    <td>
        <%: Html.TextBox(propertyName, Model, Html.GetUnobtrusiveValidationAttributes(propertyName, ViewData.ModelMetadata).Merge("class", ViewData["class"]).Merge("data-val-remote-additionalfields", "*.Identifier,Name"))%>
