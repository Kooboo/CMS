...
(function ($, tinymce) {
    ...
    tinymce.getKoobooConfig = function (params) {
        ...
        return {
            mode: "exact",
            theme: "advanced",
            plugins: "fullscreen," + (params.autoresize !== false ? 'autoresize' : '') + ",searchreplace,inlinepopups,media,KoobooMediaLibrary",
            theme_advanced_toolbar_location: "top",
            theme_advanced_toolbar_align: "left",
            theme_advanced_buttons1: "search,replace,undo,redo,|,KoobooMediaLibrary" + (params.hasSiteName ? ",KoobooPageSelector" : "") + ",image,media,link,unlink,charmap,|,code,fullscreen",
    ...
    var injectMediaLibrary = function (win, editor) {
        ...
        temp.innerHTML = '<img title="Media Library" style="cursor:pointer;" src="' + applicationPath + 'Styles/images/icons/add.png" />';
