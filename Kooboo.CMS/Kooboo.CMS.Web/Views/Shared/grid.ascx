        ...
        <thead>
            <tr>
                ...
                <% foreach (var column in Model.GridColumns)
                   {  %>
                <th class="<%=column.PropertyName.ToLower()%> <%: column.Class %>">
        ...
        <tbody>
            ...
            <tr <% if(item.IsAlternatingItem) {%>class="even" <%} %>>
                <%if (Model.Checkable)
                  {%>
                <td>                   
                    <input type="checkbox" name="Selected" class="select" name="<%= item.Id %>" value="<%= item.Id %>"
                        idproperty="<%=Model.IdPorperty %>" <%= item.GetCheckVisible(ViewContext) ==true? "":"disabled" %> />                   
                </td>
                <%} %>
                <% foreach (var itemValue in item.GetItemValues(ViewContext))
                   {%>
                <td class='<%= itemValue.Column.Class%>'>
                    ...
                    ready: function () {
                        ...
                        $("input:checkbox.select-all").change(function () {
                            ...
                            if ($(this).attr("checked")) {
                                table.find("input:checkbox.select:not(:disabled)").attr("checked", true);
                            } else {
                        ...
                        $("a.command,a.commandWithoutStyle").click(function () {
                            var handle = $(this);
