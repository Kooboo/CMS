...
namespace Kooboo.CMS.Web2.Areas.Contents.Controllers
{
    public class ControllerBase : AreaControllerBase
    {
        static ControllerBase()
        {
            ...
            //TypeDescriptorHelper.RegisterMetadataType(typeof(Kooboo.CMS.Search.Models.SearchSetting), typeof(Kooboo.CMS.Web2.Areas.Contents.Models.SearchSetting_Metadata));
