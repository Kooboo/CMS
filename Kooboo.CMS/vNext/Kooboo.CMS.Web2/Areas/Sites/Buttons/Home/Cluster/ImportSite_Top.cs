...
{
    public class ImportSite_Top : Kooboo.Common.Web.Button.IButtonPlugin
    {
        ...
        {
            return new Kooboo.Common.Web.MvcRoute() { Area = "Sites", Controller = "Site", Action = "ImportSite" };
        }
