...
namespace Kooboo.CMS.Web2
{
    ...
    public class KoobooCMSHttpApplicationEvents : Kooboo.Common.Web.ObjectContainer.Mvc.MvcModule
    {
     ...
     //new Kooboo.CMS.Web2.Interoperability.MetaWeblog.MetaWeblogRouteHandler()));
...
";
                ...
                Kooboo.CMS.Web2.HealthMonitoring.TextFileLogger.Log(string.Format(msgFormat, args));
            };
#endif
            #endregion
            ...
            //todo:restore
            //ModelBinders.Binders.Add(typeof(Kooboo.CMS.Sites.DataRule.IDataRule), new Kooboo.CMS.Web2.Areas.Sites.ModelBinders.DataRuleBinder());
            ////ModelBinders.Binders.Add(typeof(Kooboo.CMS.Sites.DataRule.DataRuleBase), new Kooboo.CMS.Web2.Areas.Sites.ModelBinders.DataRuleBinder());
            ////ModelBinders.Binders.Add(typeof(Kooboo.CMS.Sites.DataRule.HttpDataRule), new Kooboo.CMS.Web2.Areas.Sites.ModelBinders.DataRuleBinder());

            //ModelBinders.Binders.Add(typeof(Kooboo.CMS.Sites.Models.PagePosition), new Kooboo.CMS.Web2.Areas.Sites.ModelBinders.PagePositionBinder());
            //ModelBinders.Binders.Add(typeof(Kooboo.CMS.Sites.Models.Parameter), new Kooboo.CMS.Web2.Areas.Sites.ModelBinders.ParameterBinder());
            //ModelBinders.Binders.Add(typeof(Kooboo.CMS.Sites.DataSource.IDataSource), new Kooboo.CMS.Web2.Areas.Sites.ModelBinders.DataSourceModelBinder());
            #endregion
